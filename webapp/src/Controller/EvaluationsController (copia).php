...
class EvaluationsController extends AppController
{
    ...
    public function add()
    {
        ...
        if ($this->request->is('post')) 
        {
          ...
          $max_size_attachment = ($this->viewVars['dlince_max_size_files']>=1048576)?($this->viewVars['dlince_max_size_files']/1048576).'MB':($this->viewVars['dlince_max_size_files']/1024).'KB';
                ...
                if( $users->count()>0 )
                {
                  ...
                  foreach($realUsers as $user)
                  {
                    ...
                    $email->from($this->viewVars['dlince_email_from'])
                      ...
                      ->attachments($path_course.DS.$evaluation->id.DS.$filename['name'])
                      ->send();
                    /**/
                    //DLince-Email
                  }
