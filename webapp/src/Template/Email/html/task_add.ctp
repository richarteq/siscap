...
<div id="logo" style="background-color: #FAE7EC;">
	...
	font-weight: 600;	color: #B9264F;	padding:0px; margin:0px;">Nueva tarea en Curso SISCAP</h1>
	<span style="font-size: 10px; padding:0px; margin:0px;">Sistema de capacitación</span>
</div>
<br />
<p>Se ha agregado una tarea al curso "<?= $course ?>", donde eres participante.</p>
<br />
